...
$('body').on('click', 'a.imprime-venta', function(e) {
	e.preventDefault();
	var id = $(this).parent().parent().attr("id");
	window.location = "/ventaimprime/"+ id;
});
...
$("#edit-venta-form").submit(function(e) {
	...
	$.ajax({
		...
		$(".user-created-message > p").text("Venta editada exitosamente!");
...
$('body').on('click', 'button.confirm-delete', function( e ) {
	...
	/*var url = "/pos_v3/venta/destroy/"+id;*/
